...
#<=50K is represented as 0 and >50K as 1
...
# relevant_features
# column 7 and 9 are highly correlated with coeff 0.58
# column 2 has very small correlation with output variable (0.0089), hence dropping 
